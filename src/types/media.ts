export type MediaItem={id:string;mediaType:'IMAGE'|'VIDEO';mimeType:string;visibility:'PUBLIC'|'PRIVATE';guestName?:string|null;status:string;url?:string|null;thumbnailUrl?:string|null;likes:number;createdAt:string};
