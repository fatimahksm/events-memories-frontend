...
export function ThemeEditor({ event, dictionary, scope = 'admin', onSaved }: { event: EventSummary; dictionary: Dictionary; scope?: 'admin' | 'owner'; onSaved: (event: EventSummary) => void }) {
